...
selectedCountry ='USA'
univRanking.getInformation(selectedCountry, "Desktop/comsci1026/assignment 3/TopUni.csv", "Desktop/comsci1026/assignment 3/capitals.csv")


f= open("Desktop/comsci1026/assignment 3/output.txt", "r", encoding='utf8')
information = f.read()
f.close()
...
f= open("Desktop/comsci1026/assignment 3/output.txt", "w", encoding='utf8')
information = f.write("")
f.close()
