...
public class TestDict {
	...
	try {
		...
		// if (dictionary.get(keys[3]).getKey().getLabel() == words[3]){

		// 	System.out.println("dasfjahf");

		// }
		// if (dictionary.get(keys[0]).getKey().getLabel() == words[0]){

		// 	System.out.println("dajahf");

		// }
		// if (dictionary.get(keys[1]).getKey().getLabel() == words[1]){

		// 	System.out.println("dajafdsasadfhf");
	    ...
	    if ((rec.getKey().getLabel()).compareTo(words[1]) == 0)
			...
			System.out.println("Expected: " + words[1]);
			System.out.println("Got: " + rec.getKey().getLabel());
	...
	try {
	    ...
	    if ((rec.getKey().getLabel()).compareTo(words[3]) == 0)
			...
			System.out.println("Expected: " + words[3]);
			System.out.println("Got: " + rec.getKey().getLabel());
	...
	try {
	    ...
	    if ((rec.getKey().getLabel()).compareTo(words[4]) == 0)
			...
			System.out.println("Expected: " + words[4]);
			System.out.println("Got: " + rec.getKey().getLabel());
...
if (alltests || test == 14)
	    ...
	    try {
			...
			if ((rec.getKey().getLabel()).compareTo("ponvolant") == 0) 
				...
				System.out.println("Expected: " + "ponvolant");
				System.out.println("Got: " + rec.getKey().getLabel());
...
if (alltests || test == 15)
	    ...
	    try {
			...
			if ((rec.getKey().getLabel()).compareTo("reem") == 0)
				...
				System.out.println("Expected: " + "reem");
				System.out.println("Got: " + rec.getKey().getLabel());
